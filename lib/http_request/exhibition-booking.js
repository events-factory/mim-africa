...
function getFormInputData(data) {
  ...
  data.append("event_code", "+jbr7WFH2Az1R/+sa0/nyDJBWlFJZmdaczNPdEt1SjZHaG5aRXc9PQ==");
...
const submitForm = () => {
  if (
    ...
    xhr.open(
      "POST",
      `https://app.smartevent.rw/Api/Get-Exibition-Packages-Full/Details/`
    );

    xhr.setRequestHeader("Authorization", "+jbr7WFH2Az1R/+sa0/nyDJBWlFJZmdaczNPdEt1SjZHaG5aRXc9PQ==");
    xhr.send(data);
  } else {
    $("#notification-draw").remove();
    $(".exhibition-form").prepend(`
