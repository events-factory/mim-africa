<?php
    ...
    class DB_con
    {
        ...
        {
            $result = mysqli_query($this->dbh, "SELECT * FROM trips WHERE trip IN ('Bugesera International Airport (Limited Slots)', 'Nyabarongo II Multipurpose Dam', 'Norrsken House Kigali', 'Amahoro Stadium', 'Bridge to Prosperity')");
            return $result;
        }
