...
if(isset($_POST['submit']))
{
    ...
    $totalTrip = $insertTrip->TotalTrips($trip); $totalTripLoc =
$insertTrip->TotalLocalByTrip($trip); $totalAllowed = $_POST['number'];
if(($totalTrip+1) < $totalAllowed) { if($profession == "Rwanda") {
if(($totalTripLoc/$totalAllowed)*100 < 30) { $sql = $insertTrip->insert($trip,
$name, $email, $phone_number, $hotel, $profession); echo "
<script>
  alert('Slot Booked');
</script>
"; // echo "
<script>
  showCustomAlert('Slot Booked');
</script>
"; }else{ // echo "
<script>
...
"; echo "
<script>
  showCustomAlert('No available slot');
</script>
"; } }else{ $sql = $insertTrip->insert($trip, $name, $email, $phone_number,
$hotel, $profession); echo "
<script>
  alert('Slot Booked');
</script>
"; // echo "
...
"; // echo "
<script>
  showCustomAlert('Slot Fully Booked');
</script>
"; } } ?>
...
<html lang="zxx" class="no-js">
  <head>
    ...
    <!-- other CSS files -->
    <link
      href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700"
      rel="stylesheet"
    />
    ...
    <link
      rel="stylesheet"
      href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
      integrity="sha512-fxSeDGAKxPXjX2c5g5Ri3EAhVG/5Hn6vKd8Swp1IPMxG6nRH9XUv4DjdtB6+jZn6iGh3/lOo3p8xatx6zO1I5Q=="
  ...
  <body>
    ...
    <section
      class="model-area section-gap"
      id="cars"
      style="background: url(img/5234064.jpg)"
    >
      <div class="container">
        <!-- <div class="row">
        <div class="col-10">
        ...
        <div class="row d-flex justify-content-center pb-40">
          <div
            class="col-md-8 pb-40 header-text"
        ...
        <div class="active-model-carusel">
          <div class="row align-items-center single-model item">
            <div class="col-lg-6 model-left">
              ...
              <p>
                Located 40 kilometers south of Kigali, the new Bugesera
                International Airport is scheduled for completion by late 2026,
                with an estimated cost of $2 billion. The airport will feature a
                130,000-square-meter main terminal building designed to handle 8
                million passengers annually, with future expansions expected to
                accommodate more than 14 million. Additionally, the airport will
                include a cargo terminal with the capacity to process 150,000
                tons of cargo per year. This development is set to position
                Rwanda as a significant aviation hub in Africa, contributing to
                both national and regional economic growth.
              </p>
              <button
                class="text-uppercase primary-btn"
                onclick="pickchoice('Bugesera International Airport (Limited Slots)', 41)"
                href="#home"
              >
                Book a Slot Now
              </button>
          ...
          <div class="row align-items-center single-model item">
            <div class="col-lg-6 model-left">
              ...
              <p>
                The Nyabarongo II Hydropower Plant is a vital multipurpose
                project for Rwanda’s renewable energy, water management, and
                agricultural development. Located on the Nyabarongo River, this
                project is designed to generate 43.5 MW of electricity while
                also mitigating the frequent downstream flooding that has posed
                risks to local communities. In addition to power generation, the
                dam will support irrigation and water supply efforts, playing a
                critical role in Rwanda’s sustainable development goals. The
                project, fully funded by the Government of Rwanda, involves the
                construction of a 48-meter-high concrete gravity dam with a
                crest length of 228 meters, featuring a surface power station
                equipped with two 8.5 MW Kaplan turbines. Construction began in
                late 2019 and is projected for completion by 2025. This
                hydropower project underscores Rwanda’s commitment to addressing
                both energy needs and environmental challenges.
              </p>

              <button
                class="text-uppercase primary-btn"
                onclick="pickchoice('Nyabarongo II Multipurpose Dam', 21)"
                href="#home"
              >
                Book a Slot Now
              </button>
            ...
            <div class="col-lg-6 model-right">
              <img
                class="img-fluid field-img"
                src="img/nyabarongo.jpg"
                alt=""
              />
            </div>
          </div>
          ...
          <div class="row align-items-center single-model item">
            <div class="col-lg-6 model-left">
              ...
              <p>
                Norrsken House Kigali stands as a beacon of sustainability and
                innovation, fostering entrepreneurship in the heart of Africa.
                Built on the historic premises of Ecole Belge, this
                12,000-square-meter space blends Kigali’s rich heritage with
                forward-thinking design to create East Africa’s largest hub for
                entrepreneurship. The workspace brings together a thriving
                community of purpose-driven entrepreneurs, investors, and
                changemakers, all working toward impactful solutions. As part of
                Rwanda’s digital transformation, Norrsken House offers more than
                just a workspace; it provides shared resources and a
                collaborative environment where startups at various
                stages—whether scaling or just beginning—can thrive.
                Participants will experience firsthand how Rwanda is embracing a
                sustainable future through innovation, with Norrsken serving as
                a home, knowledge center, and connector for entrepreneurs
              ...
              <button
                class="text-uppercase primary-btn"
                onclick="pickchoice('Norrsken House Kigali', 21)"
                href="#home"
              >
                Book a Slot Now
              </button>
          ...
          <div class="row align-items-center single-model item">
            <div class="col-lg-6 model-left">
              <div class="title justify-content-between d-flex">
                <h4 class="mt-20">Gaseke Suspension Bridge</h4>
              ...
              <button
                class="text-uppercase primary-btn"
                onclick="pickchoice('Gaseke Suspension Bridge', 100)"
                href="#home"
              >
                Book a Slot Now
              </button>
          ...
          <div class="row align-items-center single-model item">
            <div class="col-lg-6 model-left">
              ...
              <button
                class="text-uppercase primary-btn"
                onclick="pickchoice('Amahoro Stadium', 21)"
                href="#home"
              >
                Book a Slot Now
              </button>
        ...
        >
          <div class="col-lg-12 col-md-12 header-right">
            <h4 class="text-white pb-30">
              Book Your Spot Today! The Trip is from 8.30am
            </h4>
            <form
              class="form"
              role="form"
                ...
                <div class="col-md-12 wrap-left">
                  <div class="" id="default-select">
                    ...
                    >
                      ...
                      <option
                        value="Bugesera International Airport (Limited Slots)"
                      >
                        Bugesera International Airport (Limited Slots)
                      </option>
                      <option value="Nyabarongo II Multipurpose Dam">
              ...
              <div class="from-group">
                ...
                <div class="" id="rest-of-form">
                  ...
                  <input
                    ...
                    id="hotle"
                    name="hotel"
                    placeholder="Hotel(Where are you staying?)"
                    required
                  />
                  <input
                    class="form-control txt-field"
      ...
      <div class="container">
        <div class="row">
          <p class="mt-50 mx-auto footer-text col-lg-12">
            ...
            All rights reserved | Events Factory
          </p>
        </div>
      </div>
    </footer>
    ...
    <script
      ...
      data-cf-beacon='{"rayId":"7c61f86589599cb4","version":"2023.4.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}'
      crossorigin="anonymous"
    ></script>
  </body>
</html>
